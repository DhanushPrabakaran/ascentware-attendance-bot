...
export class ReviewTasksCard {
    static getCard(attendanceId: string, tasks: any[]) {
        ...
        body.push({
            ...
            "spacing": "Medium",
            "columns": [
                { "type": "Column", "width": "40", "items": [{ "type": "TextBlock", "text": "Task", "weight": "Bolder", "size": "Small" }] },
                { "type": "Column", "width": "30", "items": [{ "type": "TextBlock", "text": "Status", "weight": "Bolder", "size": "Small" }] },
                { "type": "Column", "width": "30", "items": [{ "type": "TextBlock", "text": "Time Taken", "weight": "Bolder", "size": "Small" }] }
            ]
        });
                        ...
                        "columns": [
                            {
                                ...
                                "width": "40",
                                "items": [
                                    { "type": "TextBlock", "text": task.taskName, "wrap": true, "weight": "Bolder" }
                                ]
                            },
                            {
                                "type": "Column",
                            ...
                            },
                            {
                                ...
                                "items": [
                                    { 
                                        ...
                                        "style": "compact", 
                                        "value": task.estimatedMinutes ? task.estimatedMinutes.toString() : "60",
                                        "choices": [ 
